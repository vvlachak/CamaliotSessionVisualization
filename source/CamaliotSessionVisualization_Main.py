...
"""
    ...
    The user should sequentially use the following functions in order to prepare the data for visualization.
        dataDictionary:      It obtains the required data
        dict2json:           Stores the required data in JSON format
...
if __name__ == '__main__':
    ...
    # Get the list of dictionaries "dataDictionary" and store the values in the {__PROJECTNAME__}.CSV file in the "\data" folder
    ...
    # To plot the histogram of the duration of the sessions (stored in the "\figures" folder)
